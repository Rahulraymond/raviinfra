            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <div class="about__img">
                        <img src="{{ asset('../../assets/img/abt.png') }}" alt="about" class="img-fluid" />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="service-item">
                        <div class="service-item__img">
                            <img src="{{ asset('../../assets/img/p1.png') }}" alt="service" class="w-100" />
                        </div>
                        <!-- /.service-item__img -->
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="service-item">
                        <div class="service-item__img">
                            <img src="{{ asset('../../assets/img/p2.png') }}" alt="service" class="w-100" />
                        </div>
                        <!-- /.service-item__img -->
                        <div class="service-item__content">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="service-item">
                        <div class="service-item__img">
                            <img src="{{ asset('../../assets/img/p3.png') }}" alt="service" class="w-100" />
                        </div>
                        <!-- /.service-item__img -->
                        <div class="service-item__content">
